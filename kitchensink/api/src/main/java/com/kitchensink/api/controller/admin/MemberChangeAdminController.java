...
import static com.kitchensink.api.Constants.ADMIN_REQUESTS;
...
public class MemberChangeAdminController {
    ...
    private static ResponseEntity<Void> redirectTo(final String path) {
    ...
    public ResponseEntity<Void> approve(@PathVariable final String id) {
        ...
        return redirectTo(ADMIN_REQUESTS);
    }
