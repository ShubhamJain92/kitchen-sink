package com.kitchensink.core.notification.email.service.impl;
...
public class SmtpEmailService implements EmailService {
    ...
    public void notifyMemberUpdateApproved(final String memberEmail, final MemberChangeRequest changeRequest) {
        ...
        final var html = """
                <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;color:#111">
                  ...
                  <p style="margin-top:12px">If anything looks wrong, contact support.</p>
                </div>
    ...
    public void notifyMemberRejected(final String memberEmail, final String reason, String memberName) {
        final var display = memberName != null ? memberName : "there";
        final var html = """
            <div style="font-family:system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;color:#111">
              <h2 style="margin:0 0 8px">Your request could not be approved</h2>
              <p>Hi %s, your request was rejected by the admin.%s</p>
            </div>
            """.formatted(
                escape(display),
                reason != null && !reason.isBlank() ? " Reason: " + escape(reason) : ""
        );

        safeSendHtml(memberEmail, "Your request is rejected", html);
    }
    ...
    private String resolveFrom() {
        ...
        try {
            ...
            var pd = SmtpEmailService.class.getClassLoader()
